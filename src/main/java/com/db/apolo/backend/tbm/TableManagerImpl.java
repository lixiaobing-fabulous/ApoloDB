...
import static com.db.apolo.common.Error.DuplicatedTableException;
import static com.db.apolo.common.Error.TableNotFoundException;
    ...
    public byte[] create(long xid, Create create) throws Exception {
        ...
        try {
            if(tableCache.containsKey(create.tableName)) {
                throw DuplicatedTableException;
            }
