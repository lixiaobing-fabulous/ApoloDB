...
import com.db.apolo.backend.parser.statement.Where;
import com.db.apolo.backend.tm.TransactionManagerImpl;
import com.db.apolo.backend.util.Panic;
import com.db.apolo.backend.util.ParseStringRes;
...
import static com.db.apolo.common.Error.FieldNotFoundException;
import static com.db.apolo.common.Error.FieldNotIndexedException;
import static com.db.apolo.common.Error.InvalidLogOpException;
import static com.db.apolo.common.Error.InvalidValuesException;
        ...
        if(where == null) {
            ...
            for (Field field : fields) {
                if(field.fieldName.equals(where.singleExp1.field)) {
                    if(!field.isIndexed()) {
                        throw FieldNotIndexedException;
                    }
                    fd = field;
                    break;
                }
